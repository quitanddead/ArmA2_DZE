...
//==================================== STATUS ==========================================
if (dayz_combat > 0) then {_battleCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_battle.paa";} else {_battleCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_battle_d.paa";};
if (r_player_injured) then {_bleedingCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_bleeding.paa";} else {_bleedingCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_bleeding_d.paa";};
if (r_player_infected) then {_infectedCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_infected.paa";} else {_infectedCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_infected_d.paa";};
if (r_player_inpain) then {_painCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_pain.paa";} else {_painCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_pain_d.paa";};
if (r_fracture_legs) then {_boneCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_bone.paa";} else {_boneCtrl ctrlSetText "addons\tmax_gui\tmax_hud_effect_bone_d.paa";};
//==================================== KILLED ==========================================
...
_humanityIcon = "addons\tmax_gui\tmax_hud_status_cap.paa";
if (_humanity > 5000) then {_humanityIcon = "addons\tmax_gui\tmax_hud_status_hero.paa"};
if (_humanity < -5000) then {_humanityIcon = "addons\tmax_gui\tmax_hud_status_bandit.paa"};
